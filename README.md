...
For information about LibreTranslate, visit: [https://libretranslate.com/](https://libretranslate.com/)

Documentation: [https://docs.libretranslate.com/](https://docs.libretranslate.com/)
...
Chat is logged in the player's original language the following general format:
